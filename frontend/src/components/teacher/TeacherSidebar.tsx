...
export default function TeacherSidebar({ isOpen, onClose }) {
  ...
  return (
    <div className={`fixed left-0 top-0 h-screen w-80 bg-[#010080] border-r border-blue-900 flex flex-col shadow-sm overflow-y-auto z-50 transition-transform duration-300 lg:translate-x-0 portal-nav ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      {/* Logo Section */}
      ...
      <nav className="flex-1 overflow-y-auto py-2 px-2" onClick={handleNavClick}>
        <ul className="space-y-0.5">
          ...
          {/* Online Sessions */}
          <li>
            <Link href="/portal/teacher/online-sessions" className={getMenuItemClasses("/portal/teacher/online-sessions")} style={getActiveStyle("/portal/teacher/online-sessions")}>
              <svg className={getIconClasses("/portal/teacher/online-sessions")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
              <span className="font-medium text-sm">Online Sessions</span>
            </Link>
          </li>

          {/* Writing Tasks */}
          <li>
            <Link href="/portal/teacher/writing-tasks" className={getMenuItemClasses("/portal/teacher/writing-tasks")} style={getActiveStyle("/portal/teacher/writing-tasks")}>
              <svg className={getIconClasses("/portal/teacher/writing-tasks")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Course Work */}
          <li>
            <Link href="/portal/teacher/course-work" className={getMenuItemClasses("/portal/teacher/course-work")} style={getActiveStyle("/portal/teacher/course-work")}>
          ...
          {/* Exams */}
          <li>
            <Link href="/portal/teacher/exams" className={getMenuItemClasses("/portal/teacher/exams")} style={getActiveStyle("/portal/teacher/exams")}>
              <svg className={getIconClasses("/portal/teacher/exams")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Oral Assignment */}
          <li>
            <Link href="/portal/teacher/oral-assignment" className={getMenuItemClasses("/portal/teacher/oral-assignment")} style={getActiveStyle("/portal/teacher/oral-assignment")}>
              <svg className={getIconClasses("/portal/teacher/oral-assignment")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Tutorials */}
          <li>
            <Link href="/portal/teacher/tutorials" className={getMenuItemClasses("/portal/teacher/tutorials")} style={getActiveStyle("/portal/teacher/tutorials")}>
              <svg className={getIconClasses("/portal/teacher/tutorials")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Policies */}
          <li>
            <Link href="/portal/teacher/policies" className={getMenuItemClasses("/portal/teacher/policies")} style={getActiveStyle("/portal/teacher/policies")}>
              <svg className={getIconClasses("/portal/teacher/policies")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
