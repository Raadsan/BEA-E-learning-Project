                ...
                <div>
                  ...
                  <div className="w-full">
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-4 rounded-xl border-2 transition-all ${paymentMethod === 'waafi' ? 'bg-blue-50 border-green-600' : 'bg-white border-gray-100'}`}
                    >
