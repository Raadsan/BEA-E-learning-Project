                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {levels.map((item, index) => (
                      ...
                      >
                        <td className="px-3 sm:px-4 py-5 align-top border-r border-gray-200">
                          <span className="text-blue-900 font-semibold text-xs sm:text-sm">
                            {item.level}
                          </span>
                        </td>
                        <td className="px-3 sm:px-4 py-5 align-top text-gray-600 text-xs sm:text-sm border-r border-gray-200">
                          {item.cefr}
                        </td>
                        <td className="px-3 sm:px-4 py-5 text-gray-600 text-xs sm:text-sm leading-relaxed border-r border-gray-200">
                          {item.focus}
                        </td>
                        <td className="px-3 sm:px-4 py-5 text-gray-600 text-xs sm:text-sm leading-relaxed">
                          {item.objectives}
                        </td>
                      </tr>
                    ))}
