        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`mt-10 sm:mt-12 text-center p-6 sm:p-8 rounded-2xl ${isDarkMode ? 'bg-[#050040]' : 'bg-white'} ${visibleSections.sections ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.5s' }}>
              <div className={`inline-flex items-center justify-center w-14 h-14 rounded-full mb-4 ${isDarkMode ? 'bg-purple-600/20' : 'bg-purple-100'}`}>
                <svg className={`w-7 h-7 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              ...
              <p className={`text-sm sm:text-base max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                If you have any questions regarding this Copyright Policy or need permission to use BEA materials, please contact us through official BEA communication channels.
              </p>
            </div>
          </div>
        </div>
