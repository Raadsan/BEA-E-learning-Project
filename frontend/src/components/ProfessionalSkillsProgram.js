...
export default function ProfessionalSkillsProgram() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section ref={sectionRefs.table} className="py-10 sm:py-14 lg:py-16 bg-white overflow-hidden">
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            {/* Section Title */}
            <h2 className={`text-xl sm:text-2xl lg:text-3xl font-serif font-bold text-center text-gray-900 mb-8 ${visibleSections.table ? 'animate-fade-in-up' : 'opacity-0'}`}>
      ...
      {/* Description Section */}
      <section ref={sectionRefs.description} className="py-8 sm:py-12 bg-white overflow-hidden">
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="space-y-6">
            <h2 className={`text-xl sm:text-2xl lg:text-3xl font-serif font-bold text-gray-900 ${visibleSections.description ? 'animate-fade-in-up' : 'opacity-0'}`}>
              Soft Skills and Workplace Training Program
            </h2>
            
            <p className={`text-gray-800 leading-relaxed text-base sm:text-lg ${visibleSections.description ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
            ...
            <h3 className={`text-lg sm:text-xl lg:text-2xl font-serif font-bold text-gray-900 mt-8 ${visibleSections.description ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
              Soft Skills and Workplace Training Program Courses We Offer
            </h3>
            
            <p className={`text-gray-800 leading-relaxed text-base sm:text-lg ${visibleSections.description ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
            ...
            <div className={`text-center ${visibleSections.description ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
              <button className="bg-blue-900 text-white px-8 py-3 rounded-full font-semibold text-sm sm:text-base hover:bg-blue-800 transition-all duration-300 hover:scale-105">
                Register Now
              </button>
            </div>
          </div>
      ...
      <section ref={sectionRefs.benefits} className="py-12 sm:py-16 lg:py-20 overflow-hidden" style={{ backgroundColor: '#f5f7fa' }}>
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <h2 className={`text-2xl sm:text-3xl lg:text-4xl font-serif italic font-bold text-center mb-12 ${visibleSections.benefits ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ color: '#1a1a80' }}>
            ...
            <div className="space-y-5">
              ...
              <div 
                className={`bg-white rounded-lg p-6 sm:p-8 flex items-center gap-6 shadow-sm ${visibleSections.benefits ? 'animate-fade-in-up' : 'opacity-0'}`}
              ...
              >
                ...
                <p className="text-sm sm:text-base" style={{ color: '#1a1a80' }}>
                  <span className="font-semibold">Practical Learning</span>{" "}
                  <span className="font-normal text-gray-600">— Every module connects theory to real-world performance.</span>
                </p>
              </div>
              ...
              >
                <div className="flex-shrink-0 w-14 h-14 flex items-center justify-center">
                  <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" stroke="#1a1a80" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="text-sm sm:text-base" style={{ color: '#1a1a80' }}>
                  ...
                  <span className="font-normal text-gray-600">— Programs are aligned with the UNESCO 21st Century Skills Framework and international workplace standards.</span>
                </p>
              </div>
              ...
              >
                ...
                <p className="text-sm sm:text-base" style={{ color: '#1a1a80' }}>
                  ...
                  <span className="font-normal text-gray-600">— Delivered by experienced trainers, educators, and industry professionals.</span>
                </p>
              </div>
              ...
              >
                ...
                <p className="text-sm sm:text-base" style={{ color: '#1a1a80' }}>
                  ...
                  <span className="font-normal text-gray-600">— Empowering learners to move from competence to confidence in any professional field.</span>
                </p>
              </div>
            </div>
          </div>
