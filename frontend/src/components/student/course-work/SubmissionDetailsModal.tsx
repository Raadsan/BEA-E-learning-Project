                ...
                <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="space-y-3 pt-1">
                        ...
                        {fileUrl ? (
                            <button
                                type="button"
                                onClick={() => openSubmissionFile(assignment.file_url).catch(() => {})}
                                className="flex items-center gap-3 px-3 py-2.5 rounded-lg border bg-gray-50 dark:bg-gray-900 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors group w-full text-left"
                            >
