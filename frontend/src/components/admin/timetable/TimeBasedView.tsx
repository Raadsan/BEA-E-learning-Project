                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <ul className="text-xs space-y-1.5 font-medium opacity-90">
                                    <li>G�� <span className="font-bold">Weekly Classes</span> repeat automatically every week. Editing one updates the global pattern.</li>
                                    <li>G�� <span className="font-bold">Events & Holidays</span> are date-specific. Holidays will automatically suppress recurring classes.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
