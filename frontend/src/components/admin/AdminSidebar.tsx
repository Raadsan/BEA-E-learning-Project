          ...
          <li>
            ...
            {openSection === 'studentManagement' && (
              <ul className="mt-1 ml-4 space-y-1 border-l-2 border-white/20 pl-2">
                ...
                {allowPage("student_management", "deleted_students") && (
                <li>
                  <Link href="/portal/admin/students/trash" className={getSubMenuItemClasses("/portal/admin/students/trash")} style={getSubActiveStyle("/portal/admin/students/trash")}>
                    <svg className={`w-4 h-4 ${isActive("/portal/admin/students/trash") ? 'text-white' : 'text-gray-300'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
                    <span className={isActive("/portal/admin/students/trash") ? 'text-white' : 'text-gray-100'}>Deleted Students (Trash)</span>
                  </Link>
                </li>
                )}
              </ul>
          ...
          <li>
            ...
            {openSection === 'communication' && (
              <ul className="mt-1 ml-4 space-y-1 border-l-2 border-white/20 pl-2">
                ...
                {allowPage("communication", "tutorials") && (
                <li>
                  <Link href="/portal/admin/communication/tutorials" className={getSubMenuItemClasses("/portal/admin/communication/tutorials")} style={getSubActiveStyle("/portal/admin/communication/tutorials")}>
                    <svg className={`w-4 h-4 ${isActive("/portal/admin/communication/tutorials") ? 'text-white' : 'text-gray-300'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span className={isActive("/portal/admin/communication/tutorials") ? 'text-white' : 'text-gray-100'}>Tutorials</span>
                  </Link>
                </li>
                )}
                {allowPage("communication", "policies") && (
                <li>
                  <Link href="/portal/admin/communication/policies" className={getSubMenuItemClasses("/portal/admin/communication/policies")} style={getSubActiveStyle("/portal/admin/communication/policies")}>
                    <svg className={`w-4 h-4 ${isActive("/portal/admin/communication/policies") ? 'text-white' : 'text-gray-300'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span className={isActive("/portal/admin/communication/policies") ? 'text-white' : 'text-gray-100'}>Policies</span>
                  </Link>
                </li>
                )}
              </ul>
