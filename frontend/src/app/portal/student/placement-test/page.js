...
export default function PlacementTestIntroPage() {
  ...
  const handleStartTest = () => {
    setIsStarting(true);
    router.push("/portal/student/placement-test/take");
  };
        ...
        <div className="w-full px-8 pt-6 pb-6 flex items-center justify-center min-h-full">
          <div className="bg-white rounded-xl shadow-md p-8 max-w-2xl w-full border border-gray-100">
            ...
            <p className="text-gray-600 text-center mb-8">
              This test will help us determine your current English proficiency level and recommend the most suitable course for you.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">60 minutes</p>
              </div>
            </div>
