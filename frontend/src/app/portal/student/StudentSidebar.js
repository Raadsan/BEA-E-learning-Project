      ...
      <nav className="flex-1 overflow-y-auto py-2 px-2">
        {showMyCourses ? (
          ...
          <ul className="space-y-0.5">
            ...
            <li>
              <Link
                href="/portal/student/writing-tasks"
                className={getMenuItemClasses("/portal/student/writing-tasks")}
                style={getActiveStyle("/portal/student/writing-tasks")}
              >
            ...
            <li>
              <Link
                href="/portal/student/course-work"
                className={getMenuItemClasses("/portal/student/course-work")}
                style={getActiveStyle("/portal/student/course-work")}
              >
            ...
            <li>
              <Link
                ...
                className={getMenuItemClasses("/portal/student/tests")}
                style={getActiveStyle("/portal/student/tests")}
              >
            ...
            <li>
              <Link
                ...
                className={getMenuItemClasses("/portal/student/term-cycle-info")}
                style={getActiveStyle("/portal/student/term-cycle-info")}
              >
            ...
            <li>
              <Link
                href="/portal/student/student-review"
                className={getMenuItemClasses("/portal/student/student-review")}
                style={getActiveStyle("/portal/student/student-review")}
              >
            ...
            <li>
              <Link
                href="/portal/student/progress-report"
                className={getMenuItemClasses("/portal/student/progress-report")}
                style={getActiveStyle("/portal/student/progress-report")}
              >
            ...
            <li>
              <Link
                ...
                className={getMenuItemClasses("/portal/student/grades")}
                style={getActiveStyle("/portal/student/grades")}
              >
            ...
            <li>
              <Link
                href="/portal/student/my-certification"
                className={getMenuItemClasses("/portal/student/my-certification")}
                style={getActiveStyle("/portal/student/my-certification")}
              >
          ...
          <ul className="space-y-0.5">
            ...
            {isApproved && (
              <>
                ...
                <li>
                  <Link
                    href="/portal/student/freezing-request"
                    className={getMenuItemClasses("/portal/student/freezing-request")}
                    style={getActiveStyle("/portal/student/freezing-request")}
                  >
                    <svg
                      className={getIconClasses("/portal/student/freezing-request")}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className={getTextClasses("/portal/student/freezing-request")}>
                      Freezing Request
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    href="/portal/student/session-change"
                    className={getMenuItemClasses("/portal/student/session-change")}
                    style={getActiveStyle("/portal/student/session-change")}
                  >
                    <svg
                      className={getIconClasses("/portal/student/session-change")}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className={getTextClasses("/portal/student/session-change")}>
                      Session Change
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    ...
                    className={getMenuItemClasses("/portal/student/tutorials")}
                    style={getActiveStyle("/portal/student/tutorials")}
                  >
                    <svg
                      className={getIconClasses("/portal/student/tutorials")}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className={getTextClasses("/portal/student/tutorials")}>
                      Tutorials
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    ...
                    className={getMenuItemClasses("/portal/student/policies")}
                    style={getActiveStyle("/portal/student/policies")}
                  >
                    <svg
                      className={getIconClasses("/portal/student/policies")}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className={getTextClasses("/portal/student/policies")}>
                      Policies
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    href="/portal/student/student-support"
                    className={getMenuItemClasses("/portal/student/student-support")}
                    style={getActiveStyle("/portal/student/student-support")}
                  >
                    <svg
                      className={getIconClasses("/portal/student/student-support")}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
