                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-2 gap-4">
                        ...
                        <div className="flex items-center gap-1">
                            <select
                                ...
                                className={`px-3 py-2 border rounded-xl font-semibold text-sm transition-all focus:outline-none focus:ring-2 focus:ring-blue-500/10 ${isDark ? 'bg-gray-800 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-700'}`}
                            >
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <ul className="text-xs space-y-1.5 font-medium opacity-90">
                                    <li>ΓÇó <span className="font-bold">Weekly Classes</span> repeat automatically every week. Editing one updates the global pattern.</li>
                                    <li>ΓÇó <span className="font-bold">Events & Holidays</span> are date-specific. Holidays will automatically suppress recurring classes.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
