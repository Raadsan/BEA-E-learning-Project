...
import { useGetAllTeacherReviewsQuery } from "@/lib/api/reviewApi";
...
export default function TeacherReviewsPage() {
    ...
    // Class list extracted from teacher reviews
    ...
    return (
        <div className="p-6">
            <div className="mb-6 pb-4 border-b border-gray-200 dark:border-gray-800">
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Teacher Reviews</h1>
                <p className="text-sm text-gray-500 mt-1">Overview of teacher feedback and evaluations submitted by students.</p>
            </div>
