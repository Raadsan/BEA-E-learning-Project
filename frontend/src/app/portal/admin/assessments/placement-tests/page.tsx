...
import { useGetPlacementTestsQuery, useDeletePlacementTestMutation } from "@/lib/api/placementTestApi";
...
export default function PlacementTestsPage() {
    ...
    const { canView, canAdd, canEdit, canDelete } = usePagePermissions("assessments", "placement_tests");
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            {test.status === 'draft' ? (
                                                ...
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        router.push(`/portal/admin/assessments/placement-tests/create?id=${test.id}`);
                                                    }}
