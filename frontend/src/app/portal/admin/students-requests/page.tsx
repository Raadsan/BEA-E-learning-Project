...
import { useGetFreezingRequestsQuery } from "@/lib/api/freezingApi";
import { useGetLevelUpRequestsQuery, useUpdateLevelUpRequestStatusMutation } from "@/lib/api/levelUpApi";
