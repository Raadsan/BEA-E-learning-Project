...
export default function AdminDashboard() {
  ...
  let programStats = (programsData || []).map(program => {
    ...
    const count = studentsArray.reduce((acc, student) => {
      ...
      // Check direct program link by ID or literal program title match
      if (
        student.chosen_program == program.id ||
        (student.chosen_program && student.chosen_program.toLowerCase().trim() === program.title.toLowerCase().trim())
      ) {
        inProgram = true;
      }
