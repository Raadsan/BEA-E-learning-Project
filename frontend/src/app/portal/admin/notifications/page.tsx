                                    ...
                                    <div className="flex items-center p-4 gap-4">
                                        <div className="flex-shrink-0">
                                            {notification.sender_image ? (
                                                <Image src={resolveMediaUrl(notification.sender_image)} alt={notification.sender_name || "User"} width={48} height={48} className="w-12 h-12 rounded-full object-cover border border-gray-200 dark:border-gray-600" />
                                            ) : (
