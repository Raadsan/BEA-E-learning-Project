...
import { useGetClassesQuery, useCreateClassMutation, useUpdateClassMutation, useDeleteClassMutation } from "@/lib/api/classApi";
...
import AssignTeacherModal from "@/components/admin/classes/AssignTeacherModal";
import ClassConfirmationModal from "@/components/admin/classes/ClassConfirmationModal";
import ClassViewModal from "@/components/admin/classes/ClassViewModal";
import { createdByColumn } from "@/utils/auditDisplay";
...
export default function ClassesPage() {
  ...
  const handleViewDetails = useCallback((classItem) => {
  ...
  return (
    <>
      ...
      <ClassViewModal
        ...
        onClose={() => { setIsViewModalOpen(false); setViewingClass(null); }}
