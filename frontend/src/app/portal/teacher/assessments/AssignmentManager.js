...
export default function AssignmentManager({ type, title, description }) {
    ...
    return (
        <div className={`min-h-screen transition-colors ${isDark ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
            <TeacherHeader />
            <main className="flex-1 overflow-y-auto p-8 pt-24 bg-gray-100 dark:bg-gray-900 transition-colors">
                                        ...
                                        >
                                            ...
                                            <div className="flex justify-between items-start mb-3">
                                                ...
                                                <button
                                                    ...
                                                    className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${assignment.status === 'inactive'
                                            ...
                                            <div className="flex gap-2 mt-4">
                                                <button
                                                    ...
                                                    className={`flex-1 py-2 rounded-lg text-xs font-semibold transition-colors ${isDark ? 'bg-gray-700 hover:bg-gray-600 text-gray-200' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'}`}
                                                >
                                                    Edit
                                                </button>
                                                <button
