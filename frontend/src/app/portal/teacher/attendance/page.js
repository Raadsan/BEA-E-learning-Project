  ...
  const columns = [
    {
      ...
      width: "50px",
      className: "hidden sm:table-cell" // Hide on very small mobile
    },
    { label: "Name", key: "full_name" },
    { label: "Email", key: "email", className: "hidden lg:table-cell" }, // Hide on tablet and mobile
    { label: "Phone", key: "phone", render: (row) => row.phone || 'N/A', className: "hidden xl:table-cell text-xs" }, // Hide on mostly everything except big screens
    {
      label: "Hour 1",
      key: "hour1",
      render: (row) => (
        <label className="flex items-center justify-center cursor-pointer w-full h-full">
          <input
            type="checkbox"
            className="w-5 h-5 rounded text-[#010080] focus:ring-[#010080]/30 cursor-pointer"
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <div className="flex gap-4">
                      <label className={`flex items-center gap-2 cursor-pointer ${isDark ? 'text-white' : 'text-gray-900'}`}>
                        <input type="checkbox" className="w-4 h-4 rounded text-[#010080]" onChange={(e) => handleMarkAllHour1(e.target.checked)} />
                        <span className="text-sm font-medium">All Hour 1</span>
                      </label>
                      <label className={`flex items-center gap-2 cursor-pointer ${isDark ? 'text-white' : 'text-gray-900'}`}>
                        <input type="checkbox" className="w-4 h-4 rounded text-[#010080]" onChange={(e) => handleMarkAllHour2(e.target.checked)} />
